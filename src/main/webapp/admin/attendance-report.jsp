...
<head>
    ...
    <title>AMS Admin - Attendance Reports</title>
    <!-- Core UI CSS -->
...
<body>
            ...
            <main class="content-body animate-fade">
                ...
                <div class="card filter-card">
                    <div class="card-header" style="margin-bottom: 12px; padding-bottom: 0;">
                        <h4 class="card-title">Filter Selection Criteria</h4>
                    </div>
                    <div class="card-body">
                ...
                <div class="action-buttons-group">
                    <div>
                        <input type="text" id="searchInput" class="form-control" placeholder="Search report list..." style="max-width: 300px;">
                    </div>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            let url = `${pageContext.request.contextPath}/admin/reports?action=export`;
